...
sent_Be2 = 'You cannot end a sentence with because because because is a conjunction'

split_Sent2 = sent_Be2.split()

position_Sent2 = split_Sent2.rindex('because')

print(f"The position of the first occurrence of 'because' is: {position_Sent2}")
